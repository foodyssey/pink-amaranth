...
You can [create a site](https://app.stackbit.com/create?theme=https://github.com/stackbit/stackbit-theme-app&utm_source=project-readme&utm_medium=referral&utm_campaign=user_themes) just like this one, or explore some variations. How about a different:
...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/7k4ftv7e/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://pink-amaranth-77774.sanity.studio/.
...
Generated at `2021-03-21T16:44:23.860Z` by Stackbit version `0.3.50`.